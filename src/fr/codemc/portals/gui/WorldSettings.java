...
public class WorldSettings implements GuiBuilder {
    ...
    public void contents(Player player, Inventory inv) {
        ...
        inv.setItem(2, createNetherPortal ? new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.prohibit-nether-portal-creation.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.prohibit-nether-portal-creation.lore")).toItemStack() :
                        new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.allow-nether-portal-creation.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.allow-nether-portal-creation.lore")).toItemStack());
        inv.setItem(3, enterNetherPortal ? new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.prohibit-nether-portal-entering.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.prohibit-nether-portal-entering.lore")).toItemStack() :
                new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.allow-nether-portal-entering.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.allow-nether-portal-entering.lore")).toItemStack());
        inv.setItem(5, createEndPortal ? new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.prohibit-ender-eyes-placing.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.prohibit-ender-eyes-placing.lore")).toItemStack() :
                new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.allow-ender-eyes-placing.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.allow-ender-eyes-placing.lore")).toItemStack());
        inv.setItem(6, enterEndPortal ? new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.prohibit-end-portal-entering.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.prohibit-end-portal-entering.lore")).toItemStack() :
                new ItemBuilder(Material.SKULL_ITEM, 1, (short) 3).setSkullOwner("stone").setName(Translator.translateMessage("gui.worlds-settings.items.allow-end-portal-entering.name")).setLore(Translator.translateMessage("gui.worlds-settings.items.allow-end-portal-entering.lore")).toItemStack());
