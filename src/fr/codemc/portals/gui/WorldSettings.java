...
public class WorldSettings implements GuiBuilder {
    ...
    public void contents(Player player, Inventory inv) {
        ...
        inv.setItem(0, new ItemBuilder(Skull.getCustomSkull("http://textures.minecraft.net/texture/af33e7bb1256a12b5c88e705f21274fd8618bbde93c0dd3e22d9dbcf0b3a12b3")).setName("§eSettings of §6" + world).setLore(loreSeparator,"§eCreating nether portals ⟶ " + (createNetherPortal ? "§aAllowed" : "§cProhibided"), "§eEntering in nether portals ⟶ " + (enterNetherPortal ? "§aAllowed" : "§cProhibided"), "§ePlacing eyes of ender on end frames ⟶ " + (createEndPortal ? "§aAllowed" : "§cProhibided"), "§eEntering in end portals ⟶ " + (enterEndPortal ? "§aAllowed" : "§cProhibided"), loreSeparator).toItemStack());
